...
def main(page: ft.Page):
    ...
    def enviar_click_streaming(e):
        ...
        prompt_personaje = (
            f"Eres {PERSONAJE} {EMOJI_PERSONAJE}."
        ...
        try:
            ...
            if not completo:
                completo = "⚠️ No se recibió respuesta del modelo."
            live_text.value = completo
            page.update()
    ...
    page.add(
        ft.Container(
            content=ft.Column([
                    ...
                    mensajes,
                    ft.Row([
                        ft.ElevatedButton("🎤Probar voz", on_click=probar_voz, bgcolor=ft.Colors.BLUE_400, color=ft.Colors.WHITE),
                        ft.TextButton("🗑️Limpiar chat", on_click=limpiar_chat),
